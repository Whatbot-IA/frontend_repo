    ...
    <div className="min-h-screen bg-white">
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center lg:grid lg:grid-cols-3">
            ...
            <div className="hidden lg:flex justify-end">
              <button onClick={handleSignUp} className="bg-gradient-to-r from-whatsapp-primary to-whatsapp-secondary text-white px-6 py-2.5 rounded-full font-medium hover:shadow-lg hover:-translate-y-0.5 transition-all">
                Começar Agora
              </button>
            </div>
          </div>
          ...
          <div className={`lg:hidden overflow-hidden transition-all duration-300 ${menuOpen ? 'max-h-96 mt-4' : 'max-h-0'}`}>
            <ul className="flex flex-col gap-4 py-4 border-t">
              ...
              <li><button onClick={() => scrollToSection('how-it-works')} className="text-gray-700 hover:text-whatsapp-primary font-medium transition">Como Funciona</button></li>
              <li><button onClick={() => scrollToSection('plans')} className="text-gray-700 hover:text-whatsapp-primary font-medium transition">Planos</button></li>
              <li><button onClick={handleSignUp} className="bg-gradient-to-r from-whatsapp-primary to-whatsapp-secondary text-white px-6 py-2.5 rounded-full font-medium w-full hover:shadow-lg transition">Começar Agora</button></li>
            </ul>
          </div>
        </nav>
      </header>
      ...
      <section id="contact" className="min-h-screen flex items-center px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-whatsapp-primary to-whatsapp-secondary text-white text-center pt-16 lg:pt-0">
        <div className="max-w-4xl mx-auto w-full">
          ...
          <button onClick={handleSignUp} className="bg-white text-whatsapp-primary px-12 py-4 rounded-full font-bold text-xl shadow-2xl hover:scale-105 transition-transform">
            Criar Conta Grátis
          </button>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} Whatbot IA. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
